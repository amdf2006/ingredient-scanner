...
async function callAnthropicAPI(ingredients, maxRetries = 3) {
  const prompt = [
    ...
    '',
    '그리고 이 제품이 어떤 종류인지 추정하고, 관련된 YouTube 검색어를 3~5개 제안해줘.',
    '',
    ...
    '    }',
    '  ],',
    '  "category": "이 제품이 무엇인지 추정 (예: 토마토 파스타 소스, 클렌징 폼, 세탁 세제 등)",',
    '  "product_type": "food" 또는 "cosmetic" 또는 "cleaning" 또는 "medicine" 또는 "other",',
    '  "youtube_searches": [',
    '    "YouTube에서 사용자가 관심가질 만한 검색어 1",',
    '    "YouTube에서 사용자가 관심가질 만한 검색어 2",',
    '    "YouTube에서 사용자가 관심가질 만한 검색어 3"',
    '  ]',
    '}',
    '',
    '규칙:',
    ...
    '',
    'YouTube 검색어 규칙:',
    '- 식품 재료 → 그 재료로 만드는 인기 레시피 검색어',
    '  예: 토마토 소스 → ["토마토 파스타 만들기", "홈메이드 토마토 소스 레시피", "간단 이탈리안 요리"]',
    '- 화장품 → 그 제품 종류의 사용법/리뷰 검색어',
    '  예: 클렌징 폼 → ["클렌징 폼 추천", "올바른 세안법", "민감성 피부 세안"]',
    '- 세제/청소용품 → 사용법/비교 검색어',
    '- 언어: 한국 사용자 대상이므로 한국어로 작성 (다만 영어 제품이면 영어 섞어도 OK)',
    '- 3개 이상 5개 이하',
    '',
    '성분표:',
    ingredients
